...
global {
	...
	reflex save_result when: (nb_people_infected > 0) and (nb_people_not_infected > 0){
		save ("cycle: "+ cycle + "; Infected: " + nb_people_infected
			+ "; Susceptible: " + nb_people_not_infected)
	   		to: "Midpoint.txt" type: "text" rewrite: (cycle = 0) ? true : false;
